...
import com.sql.agent.database.DatabaseInspector;
import com.sql.agent.domain.AnalysisReport;
...
import com.sql.agent.domain.SqlAnalysisContext;
import com.sql.agent.domain.TableRef;
import com.sql.agent.parser.SqlTableExtractor;
